...
class CodeGenConfig(
    ...
    var schemaFiles: Set<java.io.File> = emptySet(),
    var schemaJarFilesFromDependencies: List<java.io.File> = emptyList(),
    var outputDir: java.nio.file.Path = java.nio.file.Paths.get("generated"),
    var examplesOutputDir: java.nio.file.Path = java.nio.file.Paths.get("generated-examples"),
    var writeToFiles: Boolean = false,
    var packageName: String = "com.netflix.${java.nio.file.Paths.get("").toAbsolutePath().fileName}.generated",
    ...
    var generatedDocsFolder: java.nio.file.Path = java.nio.file.Paths.get("generated-docs"),
